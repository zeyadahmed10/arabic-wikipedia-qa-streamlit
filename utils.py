...
tokenizer = AutoTokenizer.from_pretrained("ZeyadAhmed/AraElectra-Arabic-SQuADv2-CLS", do_lower_case = False)
qa_pipe = pipeline("question-answering", model="ZeyadAhmed/AraElectra-Arabic-SQuADv2-QA")
tokenizer_kwargs = {'truncation':True,'max_length':512}
cls_pipe = pipeline('text-classification', model="ZeyadAhmed/AraElectra-Arabic-SQuADv2-CLS")
#cls_pip = pipeline("")
